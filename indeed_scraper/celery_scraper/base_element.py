...
class BaseElement(object):
    ...
    def find_elem(self):
        try:
            ...
            Log.log_message('Element NOT found!: {locator} \n'.format(
    ...
    def find_elems(self):
        try:
            ...
            Log.log_message('Elements NOT found!: {locator} \n'.format(
                locator=self.locator))
            # with open(cwd+'/log.txt', 'a') as f:
    ...
    def find_next_page(self):
        try:
            ...
            Log.log_message('Next-Page NOT found!: {locator} \n'.format(
                locator=self.locator))
            # with open(cwd+'/log.txt', 'a') as f:
    ...
    def input_text(self, txt):
        try:
            ...
            Log.log_message('FAILED to send input-text!')
            # with open(cwd+'/log.txt', 'a') as f:
    ...
    def click(self):
        try:
            ...
            Log.log_message('Unable to Click!: {locator} \n'.format(
                locator=self.locator))
    ...
    def click_next_page(self):
        try:
            ...
            Log.log_message('Next Page Not Clicked!: {locator} \n'.format(
                locator=self.locator))
            # with open(cwd+'/log.txt', 'a') as f:
